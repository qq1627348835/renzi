  ...
  <div class="user-info">
      ...
      <el-row class="inline-info">
        <el-col :span="12">
          <el-form-item label="员工头像">
            <UploadImg :default-url="employeesAvatar" @on-success="uploadAvatstarSuccess" />
          </el-form-item>
        </el-col>
      </el-row>
      <!-- 保存个人信息 -->
    ...
    <el-form label-width="220px">
      <div class="block">
        ...
        <UploadImg ref="uploadAvatar" :default-url="employeesPic" @on-success="uploadPicSuccess" />
